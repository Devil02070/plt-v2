...
const applyParticleEffect = (
  ...
  //hover
  const enter = isTouchInteraction ? "touchstart" : "mouseenter"
  const leave = isTouchInteraction ? "touchend" : "mouseleave"
  const move = isTouchInteraction ? "touchmove" : "mousemove"
  ...
  //hover
  element.addEventListener(move, updateMousePosition, { passive: true })
  element.addEventListener(enter, (e) => {
    updateMousePosition(e)
    autoAddParticle = true
  }, { passive: true })
  ...
  return () => {
    ...
    element.removeEventListener(enter, tapHandler)
